...
public class _DataNodeStub extends org.omg.CORBA.portable.ObjectImpl implements api.DataNode
{
  ...
  public int getBlockSize (int block_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getBlockSize", true);
                $out.write_long (block_id);
                $in = _invoke ($out);
                int $result = $in.read_long ();
                return $result;
  ...
  public void createBlock (int block_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createBlock", true);
                $out.write_long (block_id);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
